...
public class WordLadderTester {
	...
	public void testBFS11() {
		ArrayList<String> res = Main.getWordLadderBFS("brain", "crane");
	...
	public void testBFS12() {
		ArrayList<String> res = Main.getWordLadderBFS("study", "train");
	...
	public void testDFS11() {
		ArrayList<String> res = Main.getWordLadderDFS("study", "train");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testDFS12() {
		ArrayList<String> res = Main.getWordLadderDFS("brain", "crane");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testPrintLadder1() {
		ArrayList<String> res = Main.getWordLadderBFS("jesus", "rapto");
		outContent.reset();
		Main.printLadder(res);
		String str = outContent.toString().replace("\n", "").replace(".", "").trim();
		assertEquals("no word ladder can be found between jesus and rapto", str);
	}
}
